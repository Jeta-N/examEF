...
import { faBars, faSignOut, faSignIn, faHome, faCubes, faUser, faUsers, faFlaskVial, faCity, faPlane, faCalendar } from '@fortawesome/free-solid-svg-icons'
...
const DefaultLayout: React.FC<{
    ...
    function getMenu(): MenuProps['items'] {
        ...
        menu.push({
            key: '/plane',
            label: 'Plane',
            icon: <FontAwesomeIcon icon={faPlane}></FontAwesomeIcon>,
